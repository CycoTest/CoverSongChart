//Music Player
const music = new Audio('/music/dream.mp3');
...
back.addEventListener('click', ()=>{
    ...
    document.getElementById(`${index}`).classList.remove('bx-play-circle');
    document.getElementById(`${index}`).classList.add('bx-pause-circle');
    makeAllBackgrounds();
    Array.from(document.getElementsByClassName('songItem'))[`${index-1}`].style.background = "rgb(105, 105, 170, .1)";
